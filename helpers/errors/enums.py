...
class DBErrorCodes(IntEnum):
    ...
    #   TEMPLATE_TYPE
    _TEMPLATE_TYPE = _BASE + 800
    DB_TEMPLATE_TYPE_INSERT = _TEMPLATE_TYPE + 1
    DB_TEMPLATE_TYPE_UPDATE_BY_ID = _TEMPLATE_TYPE + 2
    DB_TEMPLATE_TYPE_SELECT_ALL = _TEMPLATE_TYPE + 3
    DB_TEMPLATE_TYPE_SELECT_BY_ID = _TEMPLATE_TYPE + 4
    DB_TEMPLATE_TYPE_SELECT_BY_DESC = _TEMPLATE_TYPE + 5
    #   END_TEMPLATE_TYPES

    #   TEMPLATE
    _TEMPLATE = _BASE + 900
    DB_TEMPLATE_INSERT = _TEMPLATE + 1
    DB_TEMPLATE_UPDATE_BY_ID = _TEMPLATE + 2
    DB_TEMPLATE_DELETE_BY_ID = _TEMPLATE + 3
    DB_TEMPLATE_SELECT_BY_UQ_TEMPLATE = _TEMPLATE + 4
    DB_TEMPLATE_SELECT_COMMON = _TEMPLATE + 5
    DB_TEMPLATE_SELECT_BY_ID = _TEMPLATE + 6
    DB_TEMPLATE_SELECT_BY_TYPE = _TEMPLATE + 7
    DB_TEMPLATE_SELECT_BY_COMPANY = _TEMPLATE + 8
    DB_TEMPLATE_GET_DATA = _TEMPLATE + 9
    #   END_TEMPLATE
